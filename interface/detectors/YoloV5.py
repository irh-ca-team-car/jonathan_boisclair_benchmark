...
class ComputeLoss:
    ...
    def __init__(self, model, autobalance=False):
        ...
        hyp['obj'] *= (640 / 640) ** 2 * 3 / m.nl  # scale to image size and layers
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                # Objectness
                iou = iou.clamp(0).type(tobj.dtype)
        ...
        return (lbox + lobj + lcls) * bs, torch.cat((lbox, lobj, lcls))
